...
//contact details
global.ownernumber = [ process.env.OWNER_NUMBER || "94787354843"],
global.ownername = process.env.OWNER_NAME || "ᴀꜱᴀɴᴋᴀ ᴄʜᴀɴᴅɪᴍᴀ",
global.ytname = "YT: AyushBotz.inc"
global.socialm = "GitHub: Ayushpandey023"
global.location = "Indian"

global.botname = process.env.BOTNAME || "★彡[Qᴜᴇᴇɴ-ᴋʀɪꜱʜ]彡★",//name of the bot

//sticker details
global.stickername = process.env.STICKER || "Qᴜᴇᴇɴ-ᴋʀɪꜱʜ",
global.packname = 'Sticker By'
global.author = process.env.AUTHOR || "ᴄʜᴀɴᴅɪᴍᴀ",
//console view/theme
global.themeemoji = '🧩'
